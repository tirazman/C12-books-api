...
use App\Middleware\RateLimit; // <-- Added RateLimit namespace import
...
return function (App $app): void {
    ...
    // -- Auth routes -------------------------------------------------
    // Define the rate limit middleware specifically for logging in
    ...
    // Attached the rate limit middleware here:
